...
text = subprocess.check_output([
    "llvm-objdump", "-dr", "--no-show-raw-insn",
    "--disassemble-symbols=p6_copy,p6_move,p6_set", binary,
], text=True)
...
print(f"PASS Debug {arch}: memcpy/memmove calls, memset " + ("call" if arch == "aarch64" else "inline rep stosb"))
